...
def load_model():
    import tensorflow as tf
    model_path = os.path.join("models", "breast_model.keras")
...
"""
        ...
        # ✅ FIX: correct variable name (agg instead of aggressiveness)
        save_test_patient(prediction, probability, stage, subtype, agg)
